...
import com.example.androidkotlinfundamentals.databinding.FragmentGuessTitleBinding
...
class GuessTitleFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.playGameButton.setOnClickListener {
            findNavController().navigate(GuessTitleFragmentDirections.actionGuessTitleFragmentToGuessGameFragment())
        }
        return binding.root
    }
}
