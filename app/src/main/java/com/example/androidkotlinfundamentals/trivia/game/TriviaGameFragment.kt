package com.example.androidkotlinfundamentals.trivia.game
...
import com.example.androidkotlinfundamentals.databinding.FragmentTriviaGameBinding

class TriviaGameFragment : Fragment() {
    data class Question(
        val text: String,
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<FragmentTriviaGameBinding>(inflater,R.layout.fragment_trivia_game,container,false)
        randomizeQuestions()
        ...
        binding.submitButton.setOnClickListener {
            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    .navigate(TriviaGameFragmentDirections.actionGameFragmentToGameOverFragment())
            }
        }
        return binding.root
    }
